...
# Esto leerá los datos que guardaste en la pestaña "Secrets" de Streamlit Cloud
...
if st.button("Guardar Predicciones"):
    if not usuario: 
        ...
        for _, row in preds.iterrows():
            # Solo guardamos si el usuario ha puesto algún resultado (opcional)
        ...
        st.success(f"¡Guardado en la nube para {usuario}!")
        st.balloons() # Pequeño toque festivo